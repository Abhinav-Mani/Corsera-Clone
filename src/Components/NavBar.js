            ...
            <div className="collapse navbar-collapse" id="navbarNav">
                <ul className="navbar-nav mr-auto">
                    <li className="nav-item ">
                        <span id="exploreAll" className="btn btn-primary">Explore <FontAwesomeIcon icon={ faChevronDown } /></span>
                    </li>
                    <li className="nav-item">
                    <form className="navbarSearch" onSubmit={(e)=>{e.preventDefault()}}>
                        <input type="text" placeholder="What do you whant to learn?" name="search"/>
                ...
                <ul className="navbar-nav ml-auto">
                    <li className="nav-item">
                        <span className="right-nav-option">
                            For Enterprise
                        </span>
                    </li>
                    <li className="nav-item">
                        <span className="right-nav-option" id="login">
                            Login
                        </span>
                    </li>
                    <li className="nav-item ">
                        <span className="btn btn-primary">Join for Free</span>
                    </li>
                </ul>
            </div>
        </nav>
